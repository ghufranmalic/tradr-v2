...
const envSchema = z.object({
  ...
  KTRADE_USERNAME_SELECTOR: z.string().default("input[name='username'], input[type='text']"),
  KTRADE_PASSWORD_SELECTOR: z.string().default("input[name='password'], input[type='password']"),
  KTRADE_SUBMIT_SELECTOR: z.string().default("button[type='submit'], button:has-text('Sign In'), button:has-text('Login'), input[type='submit']"),
